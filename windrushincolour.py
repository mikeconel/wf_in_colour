...
# /* Custom CSS for full-screen mode */
#  .stApp {
#     background-color: #1E3A8A !important; /* Windrush blue */
#     color: #2D3748 !important; /* Change text color to white */
# }

# .stExpander {
#     background-color: #FFF !important; /* Windrush blue */
#     color: #2D3748; !important; /* Change text color to white */
# }

# .stForm {
#     background-color: #F8FAFC !important; /* Windrush blue */
#     color: #2D3748; !important; /* Change text color to white */
# }
...
# # Header and subtitle
# st.markdown(
#     "<h2 style='color: #C4A747 ; text-align: center;'>Windrush in Colour Exhibition</h2>",
#     unsafe_allow_html=True
# )
# st.subheader(" ")
...
# with st.expander(" ", expanded=True):
#     st.markdown(
#     "<h2 style='color: #C4A747; text-align: center;'>Evaluation Form & Dashboard</h2>",
#     unsafe_allow_html=True
# )
#     st.markdown(
#     "<p style='color: blue; text-align: left;'>Windrush Foundation values the support we receive from the community, we want to hear your feedback of our in-person or online events. We are committed to giving you, our supporters the highest quality products and service. Your anonymous feedback will help us to ensure that both our in-person and online events are excelling in quality and variety. Click on the button below to take part. It usually takes between 4 to 6 minutes to complete. Thank you in advance.</p>",
#     unsafe_allow_html=True
# )
#     tab1, tab2 = st.tabs(["Evaluation Form", "Windrush in Colour Dashboard"])
...
#                 ])
#                 social_media = None
#                 if marketing == "Social Media":
#                     social_media = st.selectbox("Select the social media platform:", [
#                         " ", "YouTube", "Facebook", "Instagram", "WhatsApp", "Messenger", "LinkedIn",
#                         "Telegram", "Signal", "Snapchat", "TikTok"
#                     ])
...
#                     cur = conn.cursor()
#                     cur.execute('''
#                         CREATE TABLE IF NOT EXISTS windrushincolour (
#                             name TEXT, gender TEXT, age INTEGER, ethnicity TEXT, location TEXT,
#                             feedback TEXT, marketing TEXT, social_media TEXT,
#                             q1 INTEGER, q2 TEXT, q3 TEXT, q4 TEXT, q5 TEXT, q6 TEXT, mydate TEXT
#                         )
...
#                 with st.expander(" ", expanded=True):
#                     tab1, tab2, tab3, tab4 = st.tabs(["Participant Count","Gender Distribution","Age Distribution","Ethnicity Distribution"])
...
#                     with col2:
#                         st.markdown("**<span style='color: red;'>Exhibition Feedback</span>**", unsafe_allow_html=True)
#                         feedback_counts = df["q1"].value_counts().sort_index()
#                         fig, ax = plt.subplots()
#                         ax.pie(feedback_counts, labels=feedback_counts.index, autopct='%1.1f%%')
#                         st.pyplot(fig)
